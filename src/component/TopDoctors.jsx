  ...
  return (
    <div className=' flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10 '>
        ...
        <div className=" w-full grid grid-cols-auto gap-4 pt-5 gap-y-6 px-3 sm:px-0">
            ...
            <button onClick={()=>{navigate('/doctor'); scrollTo(0,0)}} className='bg-blue-100 text-gray-600 px-12 py-3 rounded-full mt-10 cursor-pointer hover:scale-105 transition-all duration-300'>More</button>
    </div>
  )
}
